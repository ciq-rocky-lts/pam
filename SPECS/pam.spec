...
# Patch from https://github.com/linux-pam/linux-pam/commit/031bb5a5d0d950253b68138b498dc93be69a64cb
Patch1000: CVE-2024-22365.patch
# Patch from https://github.com/linux-pam/linux-pam/commit/b3020da7da384d769f27a8713257fbe1001878be
Patch1001: CVE-2024-10041.patch

# Fix CVE-2025-6020

# Patch from https://github.com/linux-pam/linux-pam/commit/df86351adfbe6a5dc7a68dce1074403f97fd1046
# Add compiler compatibility header to handle cast-qual warnings safely.
# The new pam_cc_compat.h header provides macros to safely handle compiler warnings.
Patch1002: Fix-Wcast-qual-compilation-warnings.patch

# Patch from https://github.com/linux-pam/linux-pam/commit/a8b4dce7b53d73de372e150028c970ee0a2a2e97
# Add internal helper functions to improve PAM code safety and efficiency.
# The new pam_inline.h header provides a set of standardized helper functions
# for common PAM operations like string handling and array bounds checking.
Patch1003: Introduce-pam_inline-header.patch

# Patch from https://github.com/linux-pam/linux-pam/commit/584c53979874cd0caeb13d44d5477c81155fa285
# Add safer string prefix handling in PAM configuration parsing
Patch1004: Introduce-pam_str_skip_prefix_len-and-pam_str_skip_prefix.patch

# Patch from https://github.com/linux-pam/linux-pam/commit/b0ec5d1e472a0cd74972bfe9575dcf6a3d0cad1c
# Add safer file descriptor handling for PAM helper programs
# Introduces a standardized way to handle file descriptors when PAM modules run helper programs.
Patch1005: Introduce-pam_modutil_sanitize_helper_fds.patch

# Patch from https://gitlab.com/redhat/centos-stream/rpms/pam/-/commit/6a608c05dc381aaed0bec62a96a3c01ca59fed2f
# Add new inline string formatting functions pam_asprintf() and pam_snprintf(),
# along with a pam_sprintf() macro wrapper.
Patch1006: pam-inline-pam-asprintf.patch

# Patch from https://gitlab.com/redhat/centos-stream/rpms/pam/-/commit/6a608c05dc381aaed0bec62a96a3c01ca59fed2f
# Actual patch for fixing CVE-2025-6020.
# Enhance the security and reliability of the namespace initialization script
# and related code by improving string handling, error checking, and shell
# script compatibility.
Patch1007: pam-namespace-rebase.patch
#pam_namespace: move size_t declaration outside for loop for C89 compatibility
Patch1008: 0002-pam_namespace-c89-for-loop.patch
...
%patch1000 -p1 -b .CVE-2024-22365
%patch1001 -p1 -b .CVE-2024-10041
%patch1002 -p1 -b .CVE-2025-6020
%patch1003 -p1 -b .CVE-2025-6020
%patch1004 -p1 -b .CVE-2025-6020
%patch1005 -p1 -b .CVE-2025-6020
%patch1006 -p1 -b .CVE-2025-6020
%patch1007 -p1 -b .CVE-2025-6020
%patch1008 -p1 -b .c89-for-loop
...
%changelog
* Thu Aug 07 2025 Anmol Jain <ajain@ciq.com> 1.1.8-23.1
- Fix CVE-2025-6020
